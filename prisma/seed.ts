...
const teams = [
  ...
  { name: "Catar", code: "CAT", groupLabel: "B" },
  ...
  { name: "Egito", code: "EGI", groupLabel: "G" },
  { name: "Irã", code: "IRA", groupLabel: "G" },
  { name: "Nova Zelândia", code: "NZE", groupLabel: "G" },
  // Group H
  { name: "Espanha", code: "ESP", groupLabel: "H" },
  { name: "Cabo Verde", code: "CPV", groupLabel: "H" },
  { name: "Arábia Saudita", code: "SAU", groupLabel: "H" },
  ...
  // Group L
  { name: "Inglaterra", code: "ING", groupLabel: "L" },
  { name: "Croácia", code: "CRO", groupLabel: "L" },
  { name: "Gana", code: "GAN", groupLabel: "L" },
...
const groupMatches: MatchData[] = [
  ...
  { matchOrder: 27, phase: "GROUP", groupLabel: "B", homeCode: "CAN", awayCode: "CAT", date: "2026-06-18" },
  { matchOrder: 51, phase: "GROUP", groupLabel: "B", homeCode: "SUI", awayCode: "CAN", date: "2026-06-24" },
  { matchOrder: 52, phase: "GROUP", groupLabel: "B", homeCode: "UA", awayCode: "CAT", date: "2026-06-24" },
  // Group C - Jun 13, 19, 24
  { matchOrder: 5, phase: "GROUP", groupLabel: "C", homeCode: "HAI", awayCode: "ESC", date: "2026-06-13" },
  ...
  { matchOrder: 30, phase: "GROUP", groupLabel: "C", homeCode: "ESC", awayCode: "MAR", date: "2026-06-19" },
  ...
  { matchOrder: 16, phase: "GROUP", groupLabel: "G", homeCode: "BEL", awayCode: "EGI", date: "2026-06-15" },
  { matchOrder: 39, phase: "GROUP", groupLabel: "G", homeCode: "BEL", awayCode: "IRA", date: "2026-06-21" },
  { matchOrder: 40, phase: "GROUP", groupLabel: "G", homeCode: "NZE", awayCode: "EGI", date: "2026-06-21" },
  { matchOrder: 63, phase: "GROUP", groupLabel: "G", homeCode: "EGI", awayCode: "IRA", date: "2026-06-26" },
  { matchOrder: 64, phase: "GROUP", groupLabel: "G", homeCode: "NZE", awayCode: "BEL", date: "2026-06-26" },
  // Group H - Jun 15, 21, 26
  { matchOrder: 13, phase: "GROUP", groupLabel: "H", homeCode: "SAU", awayCode: "URU", date: "2026-06-15" },
  ...
  { matchOrder: 38, phase: "GROUP", groupLabel: "H", homeCode: "ESP", awayCode: "SAU", date: "2026-06-21" },
  { matchOrder: 65, phase: "GROUP", groupLabel: "H", homeCode: "CPV", awayCode: "SAU", date: "2026-06-26" },
  ...
  { matchOrder: 21, phase: "GROUP", groupLabel: "L", homeCode: "GAN", awayCode: "PAN", date: "2026-06-17" },
  { matchOrder: 22, phase: "GROUP", groupLabel: "L", homeCode: "ING", awayCode: "CRO", date: "2026-06-17" },
  { matchOrder: 45, phase: "GROUP", groupLabel: "L", homeCode: "ING", awayCode: "GAN", date: "2026-06-23" },
  { matchOrder: 46, phase: "GROUP", groupLabel: "L", homeCode: "PAN", awayCode: "CRO", date: "2026-06-23" },
  { matchOrder: 67, phase: "GROUP", groupLabel: "L", homeCode: "PAN", awayCode: "ING", date: "2026-06-27" },
  { matchOrder: 68, phase: "GROUP", groupLabel: "L", homeCode: "CRO", awayCode: "GAN", date: "2026-06-27" },
];
